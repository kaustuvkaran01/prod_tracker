...
export default function Profile() {
  return (
    <div className="p-10 flex justify-center item-center">
      <div class="flex flex-col justify-center item-center max-w-xs p-6 shadow-xl rounded-xl sm:px-12 dark:bg-coolGray-900 dark:text-coolGray-100">
        <img
        ...
        <div class="space-y-4 text-center divide-y divide-coolGray-700">
          <div class="my-2 space-y-1">
            ...
            <p class="px-5 text-xs sm:text-base dark:text-coolGray-400">
          ...
          <div class="flex justify-center pt-2 space-x-4 align-center">
            <a
              href="#"
              aria-label="GitHub"
              class="p-2 rounded-md dark:text-coolGray-100 hover:dark:text-yellow-400"
            >
              <svg
                viewBox="0 0 496 512"
